...
extern const char extra_display_data[95][5];

void lcd_update(uint8_t*, char);

void lcd_write_string(uint8_t *, char *);
void lcd_str_line(uint8_t*, char*, uint8_t);
void lcd_str_offset(uint8_t*, char*, uint8_t, uint8_t);
void lcd_extra_offset(uint8_t*, char*, uint8_t, uint8_t);

void lcd_set_pixels(uint1_t [][32] , uint8_t*);
